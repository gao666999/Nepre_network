...
val_nums = 3000
train_nums = 201000
#folder_of_dataset = '/home/xg666/Desktop/zdocktrain/140TF/train'
#LEARNING_RATE_DECY=0.96
#MOVING_AVERAGE_DECAY=0.99
# 定义input_ima=ges为图片数据
...
def get_batch_images(TFpath,is_train=True):
  with tf.device('/cpu:0'):
    ...
    traindata,trainlabel = read_tfrecords(TFpath,is_train)
    capacity = 1000+3*batch_size
    train_data,train_label = tf.train.shuffle_batch([traindata,trainlabel],batch_size = batch_size,capacity = capacity,min_after_dequeue = batch_size)
...
if __name__ == '__main__':
    train_record_file='/home/xg666/Desktop/zdocktrain/usefulTFdata/140TF/train/*.tfrecords'
    val_record_file='/home/xg666/Desktop/zdocktrain/usefulTFdata/140TF/test/*.tfrecords'
    ...
    snapshot_prefix='/home/xg666/Desktop/zdocktrain/savemodels/resnet_140/model.ckpt'
