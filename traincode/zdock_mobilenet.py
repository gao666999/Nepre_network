...
def read_tfrecords(TFpath,is_train=True):
    ...
    traindata=tf.reshape(features['data'],(20,20,1))
...
def get_batch_images(TFpath,is_train=True):
    with tf.device('/cpu:0'):
        ...
        traindata,trainlabel = read_tfrecords(TFpath,is_train=True)
        capacity = 1000+3*batch_size
        train_data,train_label = tf.train.shuffle_batch([traindata,trainlabel],batch_size = batch_size,capacity = capacity,min_after_dequeue = 64)
...
if __name__ == '__main__':
    ...
    snapshot_prefix='/home/xg666/Desktop/zdocktrain/savemodels/mobilenet_20/model.ckpt'
