...
MODEL_SAVE_PATH = '/home/xg666/Desktop/zdocktrain/savemodels/mobilenet_20/'
...
def train(PDBname):
    ...
    resultfile = os.path.join('/home/xg666/Desktop/NECNN/zdockresult/M20',str(PDBname)+str('result.txt'))
    recordfile = os.path.join('/home/xg666/Desktop/NECNN/zdockrecord/M20',str(PDBname)+str('record.txt'))
