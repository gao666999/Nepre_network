...
def get_batch_images(tffilename):
  with tf.device('/cpu:0'):
    ...
    train_data,train_label = tf.train.shuffle_batch([traindata,trainlabel],batch_size = batch_size,capacity = capacity,min_after_dequeue = 32)
...
def step_train(train_op,loss,accuracy,
    ...
    with tf.Session() as sess:
        ...
        for i in range(max_steps + 1):
            ...
            step, train_loss = sess.run([train_op, loss], feed_dict={input_images: batch_input_images,
...
if __name__ == '__main__':
    train_record_file='140*400zdocktrain.tfrecords'
    val_record_file='140*400zdocktest.tfrecords'
    ...
    snapshot_prefix='./savedmodels/resnet_zdock_140/model.ckpt'
