...
labels_nums = 2  # 类别个数
batch_size = 64  #
resize_height = 20  # 指定存储图片高度
resize_width = 20  # 指定存储图片宽度
depths = 1
val_nums = 3000
train_nums = 201000
...
def train(train_record_file,
    ...
    with slim.arg_scope(alexnet.alexnet_v2_arg_scope()):
        out, end_points = alexnet.alexnet_v2(inputs=input_images, num_classes=labels_nums, dropout_keep_prob=keep_prob, is_training=is_training)
...
if __name__ == '__main__':
    train_record_file='/home/xg666/Desktop/zdocktrain/20TF/train54-500/*.tfrecords'
    val_record_file='/home/xg666/Desktop/zdocktrain/20TF/test54-500/*.tfrecords'
    ...
    snapshot_prefix='/home/xg666/Desktop/zdocktrain/savemodels/alex_20/model.ckpt'
